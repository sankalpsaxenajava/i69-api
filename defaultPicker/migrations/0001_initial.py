    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interest', models.CharField(max_length=265)),
                ('interest_fr', models.CharField(max_length=265)),
                ('coinsPerMessage', models.IntegerField(blank=True, help_text='coins deducted when user sends a message', null=True)),
                ('coinsPerPhotoMessage', models.IntegerField(blank=True, help_text='coins deducted when user sends a photo message', null=True)),
